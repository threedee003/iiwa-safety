...
class ShelfEnv(iiwaTestBed):
      def __init__(self):
            ...
            self.create_shelf()
            self.shelf_handles = []
            for i in range(0, len(self.shelf_assets)):
                  plank_handle = self.gym.create_actor(self.env, self.shelf_assets[i], self.shelf_poses[i], f"plank_{i+1}", 0, 0)
      ...
      def create_shelf(self):
            ...
            for i in range(num_plank):
                  ...
                  self.shelf_assets.append(planks_)
