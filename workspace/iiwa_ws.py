'''
Base class for creating iiwa scene
...
class iiwaScene:
      def __init__(self,
            ...
            if sim_type == gymapi.SIM_FLEX:
                  ...
                  self.sim_params.use_gpu_pipeline = cfg.env.use_gpu_pipeline
            ...
            self.robot_handle = self.gym.create_actor(self.env, robot_, pose, "robot", 0, 0, segmentationId=1)
            # self.gym.set_rigid_body_segmentation_id(self.env, self.robot_handle, 1, 2)
